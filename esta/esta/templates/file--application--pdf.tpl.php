...
/**
 * @file
 * Replacement theme implementation to display a file inline in a paragraph.
...
<span id="<?php print $id; ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>
  ...
  <?php if (!$page): ?>
    <span<?php print $title_attributes; ?>><a href="<?php print $file_url; ?>"><?php print $label; ?></a></span>
  <?php endif; ?>
