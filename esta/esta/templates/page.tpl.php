  ...
  <div class="header__inner">
    ...
    <div class="logo-and-search">
      <div class="logo-wrapper">
        <?php if ($logo): ?>
          <?php
            $logo_alt = theme_get_setting('esta_header_logo_alt');
            ...
            if (empty(theme_get_setting('esta_header_title'))) {
              $logo_class[] = 'no-title';
            }
          ...
          ?>
        <?php endif; ?>
        <?php if (theme_get_setting('esta_header_title')): ?>
          <div class="header-title"><?php print decode_entities(theme_get_setting('esta_header_title')); ?></div>
        <?php endif; ?>
      </div>
...
<div id="page">
  ...
  <div id="main">
    <div id="content" class="column" role="main">
      <div class="content-header" <?php if (!empty($banner)): ?>style="background: url(<?php print $banner; ?>) no-repeat transparent; background-size: cover"<?php endif; ?>>
