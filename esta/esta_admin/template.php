 ...
 */
function esta_admin_preprocess_html(&$vars) {
 ...
 */
function esta_admin_preprocess_page(&$vars) {
 ...
 */
function esta_admin_admin_block_content($variables) {
 ...
 */
function esta_admin_tablesort_indicator($variables) {
 ...
 */
function esta_admin_css_alter(&$css) {
...
/**
 * Implements hook_admin_breadcrumb().
 */
function esta_admin_breadcrumb($variables) {
  $sep = ' <span></span> ';
 ...
 * @see overlay.tpl.php
 */
function esta_admin_preprocess_overlay(&$variables) {
 ...
 */
function esta_admin_system_info_alter(&$info, $file, $type) {
  if ($type == 'theme') {
 ...
 */
function esta_admin_media_wysiwyg_token_to_markup_alter(&$element) {
